 ...
 *     as applicable.
*/
MODULE_NAME='RmsNlReceiverMonitor'(DEV vdvRMS,
                                   DEV vdvDeviceModule,
...
CHAR MONITOR_ASSET_NAME[]             = 'Receiver';
...
CHAR MONITOR_NAME[]       = 'RMS Receiver Monitor';
CHAR MONITOR_DEBUG_NAME[] = 'RmsNlReceiverMon';
...
#IF_DEFINED HAS_SOURCE_SELECT
    ...
    CHAR METADATA_PROPERTY_SOURCE_INPUT[100]  = 'TUNER 1|DVD 1|AUX 1';
#END_IF

#IF_DEFINED HAS_TUNER
    METADATA_PROPERTY_STATION_PRESET_COUNT = 20;
    METADATA_PROPERTY_TUNER_BAND_COUNT     =  4;
    CHAR METADATA_PROPERTY_TUNER_BAND[100] = 'AM|FM|XM|Sirius';
#END_IF

#IF_DEFINED HAS_PREAMP
    SLONG   METADATA_PROPERTY_PREAMP_BALANCE_MIN     = -128;
    SLONG   METADATA_PROPERTY_PREAMP_BALANCE_MAX     =  128;
    INTEGER METADATA_PROPERTY_PREAMP_BALANCE_STEP    = 1;
    SLONG   METADATA_PROPERTY_PREAMP_BALANCE_INIT    = 0;
    SLONG   METADATA_PROPERTY_PREAMP_BALANCE_RESET   = 0;
    CHAR    METADATA_PROPERTY_PREAMP_BALANCE_UNITS[] = '';

    SLONG   METADATA_PROPERTY_PREAMP_BASS_MIN        = 0;
    SLONG   METADATA_PROPERTY_PREAMP_BASS_MAX        = 255;
    INTEGER METADATA_PROPERTY_PREAMP_BASS_STEP       = 1;
    SLONG   METADATA_PROPERTY_PREAMP_BASS_INIT       = 0;
    SLONG   METADATA_PROPERTY_PREAMP_BASS_RESET      = 0;
    CHAR    METADATA_PROPERTY_PREAMP_BASS_UNITS[]    = '';

    SLONG   METADATA_PROPERTY_PREAMP_TREBLE_MIN      = 0;
    SLONG   METADATA_PROPERTY_PREAMP_TREBLE_MAX      = 255;
    INTEGER METADATA_PROPERTY_PREAMP_TREBLE_STEP     = 1;
    SLONG   METADATA_PROPERTY_PREAMP_TREBLE_INIT     = 0;
    SLONG   METADATA_PROPERTY_PREAMP_TREBLE_RESET    = 0;
    CHAR    METADATA_PROPERTY_PREAMP_TREBLE_UNITS[]  = '';
#END_IF
...
DEFINE_FUNCTION RegisterAsset(RmsAsset asset)
{
  ...
  asset.assetType         = RMS_ASSET_TYPE_RECEIVER;
...
#IF_DEFINED HAS_PREAMP
    CASE 'preamp.balance' :
    {
      SEND_LEVEL vdvDeviceModule, BALANCE_LVL, nValue1
    }
    CASE 'preamp.bass' :
    {
      SEND_LEVEL vdvDeviceModule, BASS_LVL, nValue1
    }
    CASE 'preamp.treble' :
    {
      SEND_LEVEL vdvDeviceModule, TREBLE_LVL, nValue1
    }
    CASE 'preamp.loudness' :
    {
      SWITCH(nValue1)
      {
        CASE TRUE  :
        {
          PULSE[vdvDeviceModule,LOUDNESS_ON]
        }
        CASE FALSE :
        {
          IF([vdvDeviceModule,LOUDNESS_FB])
            PULSE[vdvDeviceModule,LOUDNESS]
        }
      }
    }
#END_IF
