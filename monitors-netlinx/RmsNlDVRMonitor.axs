 ...
 *     as applicable.
*/
MODULE_NAME='RmsNlDVRMonitor'(DEV vdvRMS,
                              DEV vdvDeviceModule,
...
CHAR MONITOR_ASSET_NAME[]             = 'Digital Video Recorder';
...
CHAR MONITOR_NAME[]       = 'RMS Digital Video Recorder Monitor';
CHAR MONITOR_DEBUG_NAME[] = 'RmsNlDVRMon';
...
#IF_DEFINED HAS_SOURCE_SELECT
    ...
    CHAR METADATA_PROPERTY_SOURCE_INPUT[100] = 'Satellite|Cable TV|Antenna';
#END_IF
...
DEFINE_FUNCTION RegisterAsset(RmsAsset asset)
{
  ...
  asset.assetType         = RMS_ASSET_TYPE_DIGITAL_VIDEO_RECORDER;
