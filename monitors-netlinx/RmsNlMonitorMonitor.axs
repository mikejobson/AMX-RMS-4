 ...
 *     as applicable.
*/
MODULE_NAME='RmsNlMonitorMonitor'(DEV vdvRMS,
                                  DEV vdvDeviceModule,
...
CHAR MONITOR_ASSET_NAME[]             = 'Monitor';
...
CHAR MONITOR_DEBUG_NAME[] = 'RmsNlMonitorMon';
...
DEFINE_FUNCTION RegisterAsset(RmsAsset asset)
{
  ...
  asset.assetType         = RMS_ASSET_TYPE_MONITOR;
