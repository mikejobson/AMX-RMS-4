 ...
 *     as applicable.
*/
MODULE_NAME='RmsNlSettopBoxMonitor'(DEV vdvRMS,
                                    DEV vdvDeviceModule,
...
CHAR MONITOR_ASSET_NAME[]             = 'Settop Box';
...
DEFINE_FUNCTION RegisterAsset(RmsAsset asset)
{
  ...
  asset.assetType         = RMS_ASSET_TYPE_SETTOP_BOX;
...
{
  //Register all snapi HAS_xyz components
  IF(SynchronizeAssetMetadataSnapiComponents
  (assetClientKey))
    RmsAssetMetadataSubmit(assetClientKey);
}
