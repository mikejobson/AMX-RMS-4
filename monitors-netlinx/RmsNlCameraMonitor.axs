 ...
 *     as applicable.
*/
MODULE_NAME='RmsNlCameraMonitor'(DEV vdvRMS,
                                 DEV vdvDeviceModule,
...
CHAR MONITOR_ASSET_NAME[]             = 'Camera';
...
CHAR MONITOR_DEBUG_NAME[] = 'RmsNlCameraMon';
...
#IF_DEFINED HAS_CAMERA_PRESET
    METADATA_PROPERTY_CAMERA_PRESET_COUNT  = 6;
#END_IF
...
DEFINE_FUNCTION RegisterAsset(RmsAsset asset)
{
  ...
  asset.assetType         = RMS_ASSET_TYPE_CAMERA;
...
#IF_DEFINED HAS_CAMERA_PRESET
    CASE 'camera.preset' :
    {
      SEND_COMMAND vdvDeviceModule,"'CAMERAPRESET-',ITOA(nValue1)"
    }
#END_IF
