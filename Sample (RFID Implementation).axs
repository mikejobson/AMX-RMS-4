...
//
//**********************************************************
PROGRAM_NAME='Duet Sample (RFID Implementation)'
(***********************************************************)
(* System Type : NetLinx                                   *)
(***********************************************************)
...
//
// NOTE: The RFID devices are defined inside the
...
// RMS RFID Support
//
//  If you need to implement support for Anterus RFID
//  tracking then include the 'RmsRfid' AXI include
//  file reference.
//
#INCLUDE 'RmsRfid'
